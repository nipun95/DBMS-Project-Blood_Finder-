...
<form id="form1" name="form1" method="post" action="insert_member_info.php">
  <table class="tbl_form" width="461" height="425">
    <tr>
    ...
    <tr>
      ...
      <td width="109"><font size="1" color="red">Min 8 Character & Max 10</font></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="field">:</td>
      <td colspan="2">
        <textarea name="msg" id="textarea" cols="30" rows="4"></textarea></td>
    </tr>
